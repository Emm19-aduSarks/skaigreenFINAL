                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-2 text-uppercase text-white mb-md-4">Automate your farm with us today</h1>
                            <a href="../login.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Login</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white d-flex flex-column align-items-center text-center">
                    ...
                    <div class="px-4 pb-4">
                        <h4 class="text-uppercase mb-3">Determine the farm perimeter </h4>
                        <p>The user should specify the perimeter in square meters the drone should fly within, such that the entire farm is covered </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    ...
                    <div class="px-4 pb-4">
                        <h4 class="text-uppercase mb-3">Real Time Farm Updates</h4>
                        <p>Based on the images or videos taken,disease deficiencies can be spotted by our machine learning algorithms, so you can address them. </p>
                        <a class="btn text-primary" href="">Read More <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    ...
                    <div class="px-4 pb-4">
                        <h4 class="text-uppercase mb-3">Alert users on trespassing</h4>
                        <p>When cattle or other animals tread on crops, a notification would be sent to your phone, an alarm whould go off to the alert you. </p>
                        <a class="btn text-primary" href="">Read More <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    ...
                    <div class="px-4 pb-4">
                        <h4 class="text-uppercase mb-3">Schedule flight times of drone </h4>
                        <p>On the “schedule flight times tab” on the mobile app, you can set the flight times of the drone, within a specific time window. </p>
                        <a class="btn text-primary" href="">Read More <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    ...
                    <div class="px-4 pb-4">
                        ...
                        <p>DNavigating the drone space could seem quite daunting at first, we understand. So we have designed an interactive platform to help you out</p>
                        <a class="btn text-primary" href="">Read More <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    ...
                    <div class="px-4 pb-4">
                        <h4 class="text-uppercase mb-3">Clean design</h4>
                        <p>We have designed an easy to use interface, catered for you- the farmer.</p>
                        <a class="btn text-primary" href="">Read More <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
